...
- Generated: 2026-05-04T14:06:55Z
...
| ---: | --- | --- | --- | ---: | --- |
| 1 | Backend health + pytest 30/30 | PASS | yes | 825 | health=ok, pytest=30 passed |
| 2 | Elasticsearch indices (fec-* + demo-*) green | PASS | yes | 689 | 21 found / 20 expected, fec-knowledge=2830 docs |
| 3 | Kibana saved objects (dashboards + tools + agent + .mcp + rule) | PASS | yes | 1713 | dashboards=13 (demo 10/10, customer-fit=3), fec-tools=12/12, agent=yes, mcp=1, rule=1 |
| 4 | MCP server (tools/list = 12, fec_cost_calc tool/call) | PASS | yes | 7 | tools/list=12, fec_cost_calc OK (elastic $28,080) |
| 5 | Tools REST (compute + knowledge-search; OPTIONS for heavy) | PASS | no | 14099 | cost-calc=200, capacity=200, knowledge-search=200, heavy-routes=405/405/405/405/405 |
| 6 | Workflow status + webhook handler | PASS | no | 2323 | registered=True, rule=registered, connector=registered, webhook_status=200 |
| 7 | Frontend pages reachable | PASS | yes | 21 | /=200/20693b, /index.html=200/20693b, /tools.html=200/18588b, /meeting.html?id=northwind-mtg-prev-001=200/9841b, /agent-builder.html=200/7088b, /demo-data.html=200/2628b, /workflow-demo.html=200/8201b, /fe-brain.html=200/5291b, /battlecards.html=200/8458b |
| 8 | Em/en dash audit (backend + frontend + docs + data) | PASS | no | 29 | scanned=180 files, dash hits=0 |
| 9 | Git status (uncommitted <=2; HEAD == origin/main) | FAIL | no | 64 | uncommitted=8 (modified=8, untracked=0), HEAD=69c81d9f07d4, origin/main=69c81d9f07d4 \| 8 modified files (>2) |
...
```json
{
  ...
  "7": {
    ...
    "status": "PASS",
    "duration_ms": 21,
    "notes": "/=200/20693b, /index.html=200/20693b, /tools.html=200/18588b, /meeting.html?id=northwind-mtg-prev-001=200/9841b, /agent-builder.html=200/7088b, /demo-data.html=200/2628b, /workflow-demo.html=200/8201b, /fe-brain.html=200/5291b, /battlecards.html=200/8458b",
    "detail": {
      "/": {
        "status": 200,
        "bytes": 20693
  ...
  "9": {
    ...
    "status": "FAIL",
    "duration_ms": 64,
    "notes": "uncommitted=8 (modified=8, untracked=0), HEAD=69c81d9f07d4, origin/main=69c81d9f07d4 | 8 modified files (>2)",
    "detail": {
      "uncommitted_lines": 8,
      "uncommitted_sample": [
        " M backend/app/api/routes_agent_builder.py",
        " M backend/app/integrations/agent_builder.py",

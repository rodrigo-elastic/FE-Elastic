...
| License | `![license](https://img.shields.io/badge/license-Apache%202.0-blue?style=flat-square)` |
...
- Apache 2.0 is set assuming the team flips the LICENSE file from MIT to
  Apache 2.0 before submission. If the LICENSE stays MIT, swap the badge to
  `license-MIT-blue`.

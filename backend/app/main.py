...
app.include_router(routes_customer_health.router, prefix="/api/v1")
app.include_router(routes_map.router, prefix="/api/v1")
app.include_router(routes_war_room.router, prefix="/api/v1")
